...
static const double jet_pt_cut = 20; // Cut on jet pt
static const double photon_pt_cut = 20; // Cut on photon pt
...
//static const double pbins[31] = {15., 20., 25., 30., 35., 40., 45., 50., 55., 60., 65., 70., 75., 80., 90., 100., 110., 120., 130., 140., 150., 165., 180., 200., 225., 250., 275., 300., 350., 420., 500.};
static const double pbins[14] = {20., 30., 40., 50., 60., 75., 90., 110., 140., 180., 220., 300., 400., 500.};
