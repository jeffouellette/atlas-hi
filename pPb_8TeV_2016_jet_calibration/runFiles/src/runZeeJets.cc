...
int main (int argc, char** argv) {
  ...
  switch (argc) {
   case 2:
    ...
    break;
   case 3:
    ZeeJets (dataSet, lumi);
    break;
   case 4:
    ZeeJets (dataSet, lumi, isMC);
    break;
   case 5:
    ZeeJets (dataSet, lumi, isMC, isPeriodA);
    break;
   case 6:
    ZeeJets (dataSet, lumi, isMC, isPeriodA, fileName);
    break;
   case 7:
    ZeeJets (dataSet, lumi, isMC, isPeriodA, fileName, xs);
    break;
   case 8:
    ZeeJets (dataSet, lumi, isMC, isPeriodA, fileName, xs, feff);
    break;
   case 9:
    ZeeJets (dataSet, lumi, isMC, isPeriodA, fileName, xs, feff, nevt);
    break;
  }
