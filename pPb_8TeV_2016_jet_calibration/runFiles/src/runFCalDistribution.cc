...
/**
 * Runs an instance of the FCalDistribution analysis routine.
...
int main (int argc, char** argv) {
  ...
  switch (argc) {
   case 3:
    FCalDistribution (directory, dataSet);
    break;
   case 4:
    FCalDistribution (directory, dataSet, lumi);
    break;
   case 5:
    FCalDistribution (directory, dataSet, lumi, isMC);
    break;
   case 6:
    FCalDistribution (directory, dataSet, lumi, isMC, isPeriodA);
    break;
   case 7:
    FCalDistribution (directory, dataSet, lumi, isMC, isPeriodA, fileName);
    break;
   case 8:
    FCalDistribution (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs);
    break;
   case 9:
    FCalDistribution (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs, feff);
    break;
   case 10:
    FCalDistribution (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs, feff, nevt);
    break;
  }
