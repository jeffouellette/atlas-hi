...
/**
 * Runs an instance of the ZmumuJets analysis routine.
...
int main (int argc, char** argv) {
  ...
  switch (argc) {
   case 3:
    ZmumuJets (directory, dataSet);
    break;
   case 4:
    ZmumuJets (directory, dataSet, lumi);
    break;
   case 5:
    ZmumuJets (directory, dataSet, lumi, isMC);
    break;
   case 6:
    ZmumuJets (directory, dataSet, lumi, isMC, isPeriodA);
    break;
   case 7:
    ZmumuJets (directory, dataSet, lumi, isMC, isPeriodA, fileName);
    break;
   case 8:
    ZmumuJets (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs);
    break;
   case 9:
    ZmumuJets (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs, feff);
    break;
   case 10:
    ZmumuJets (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs, feff, nevt);
    break;
  }
