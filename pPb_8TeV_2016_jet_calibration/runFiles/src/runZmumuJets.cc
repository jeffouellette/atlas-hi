...
int main (int argc, char** argv) {
  ...
  switch (argc) {
   case 2:
    ...
    break;
   case 3:
    ZmumuJets (dataSet, lumi);
    break;
   case 4:
    ZmumuJets (dataSet, lumi, isMC);
    break;
   case 5:
    ZmumuJets (dataSet, lumi, isMC, isPeriodA);
    break;
   case 6:
    ZmumuJets (dataSet, lumi, isMC, isPeriodA, fileName);
    break;
   case 7:
    ZmumuJets (dataSet, lumi, isMC, isPeriodA, fileName, xs);
    break;
   case 8:
    ZmumuJets (dataSet, lumi, isMC, isPeriodA, fileName, xs, feff);
    break;
   case 9:
    ZmumuJets (dataSet, lumi, isMC, isPeriodA, fileName, xs, feff, nevt);
    break;
  }
