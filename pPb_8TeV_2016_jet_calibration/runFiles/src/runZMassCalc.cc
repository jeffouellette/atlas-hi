...
int main (int argc, char** argv) {
  ...
  switch (argc) {
   case 2:
    ...
    break;
   case 3:
    ZMassCalc (dataSet, lumi);
    break;
   case 4:
    ZMassCalc (dataSet, lumi, isMC);
    break;
   case 5:
    ZMassCalc (dataSet, lumi, isMC, isPeriodA);
    break;
   case 6:
    ZMassCalc (dataSet, lumi, isMC, isPeriodA, fileName);
    break;
   case 7:
    ZMassCalc (dataSet, lumi, isMC, isPeriodA, fileName, xs);
    break;
   case 8:
    ZMassCalc (dataSet, lumi, isMC, isPeriodA, fileName, xs, feff);
    break;
   case 9:
    ZMassCalc (dataSet, lumi, isMC, isPeriodA, fileName, xs, feff, nevt);
    break;
  }
