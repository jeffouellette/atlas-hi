...
const short electronTrigLength = 3;
const char* electronTriggerNames[electronTrigLength] = {
 "HLT_e20_lhloose",
 "HLT_e22_lhloose",
 "HLT_e24_lhloose"
};
const float electronTriggerMinPtCuts[electronTrigLength] = {20, 22, 24};
const float electronTriggerMaxPtCuts[electronTrigLength] = {22, 24, FLT_MAX};

const short muonTrigLength = 3;
...
const float muonTriggerMinPtCuts[muonTrigLength] = {15, 18, 20};
const float muonTriggerMaxPtCuts[muonTrigLength] = {18, 20, FLT_MAX};
...
const float photonTriggerMinPtCuts[photonTrigLength] = {15, 20, 25, 30, 35, 40, 65};
const float photonTriggerMaxPtCuts[photonTrigLength] = {20, 25, 30, 35, 40, 65, FLT_MAX};
