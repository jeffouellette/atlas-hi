...
extern double** kinematicLumiVec; // total exposed luminosity in a kinematic bin. Units: ub^-1
extern Trigger*** kinematicTriggerVec; // best trigger to use in a kinematic bin.
