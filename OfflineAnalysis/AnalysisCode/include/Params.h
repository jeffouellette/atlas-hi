...
const int runNumbers[26] = {365498, 365502, 365512, 365573, 365602, 365627, 365678, 365681, 365709, 365752, 365834, 365914, 365932, 366011, 366029, 366092, 366142, 366268, 366337, 366383, 366413, 366476, 366526, 366528, 366627, 36691};
const int numRunNumbers = sizeof (runNumbers) / sizeof (runNumbers[0]);

const float lumis[26] = {0.2674, 1.018, 0.9223, 7.852, 9.897, 25.151, 16.219, 24.847, 35.472, 36.751, 5.651, 6.595, 41.822, 43.806, 42.881, 45.336, 41.946, 54.532, 44.538, 0.1853, 40.729, 42.383, 1.034, 33.016, 36.795, 55.241};
