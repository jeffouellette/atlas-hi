...
TreeVariables :: ~TreeVariables () {
  ...
  if (photon_loose) delete photon_loose;
...
void TreeVariables :: SetBranchAddresses () {
  ...
  if (isMC) {
   ...
   if (getTruthJets) {
    ...
    tree->SetBranchStatus ("truth_jet_pt", 0);
    tree->SetBranchStatus ("truth_jet_eta", 0);
    tree->SetBranchStatus ("truth_jet_phi", 0);
    tree->SetBranchStatus ("truth_jet_e", 0);
    //tree->SetBranchStatus ("truth_njet", 0);
  ...
  if (getPhotons) {
   ...
   tree->SetBranchAddress ("photon_loose", &photon_loose);
   ...
   tree->SetBranchStatus ("photon_loose", 0);
...
void TreeVariables :: SetGetSimpleJets (const bool _getSimpleJets) { getSimpleJets = _getSimpleJets; }
void TreeVariables :: SetGetHIJets (const bool _getHIJets) { getHIJets = _getHIJets; }
void TreeVariables :: SetGetEMTopoJets (const bool _getEMTopoJets) { getEMTopoJets = _getEMTopoJets; }
void TreeVariables :: SetGetElectrons (const bool _getElectrons) { getElectrons = _getElectrons; }
void TreeVariables :: SetGetPhotons (const bool _getPhotons) { getPhotons = _getPhotons; }
...
void TreeVariables :: SetGetTruthPhotons (const bool _getTruthPhotons) { getTruthPhotons = _getTruthPhotons; }
