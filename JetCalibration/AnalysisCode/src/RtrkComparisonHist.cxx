...
void RtrkComparisonHist () {
  ...
  const double* rtrk_los = linspace (0.1, 0.1, std::max (numpbins, numetabins));
  ...
  for (short iPer = 0; iPer < 3; iPer++) { // loop over period configurations
    ...
    for (short iEta = 0; iEta <= numtrketabins; iEta++) { // loop over bins in eta
      ...
      jetRtrkHist = GetProfileX ("jetRtrk_Hist", proj2d, numpbins, pbins, useGaussian, rtrk_los, rtrk_his);
      ...
      jetRtrkHist_lo = GetProfileX ("jetRtrk_Hist_lo", proj2d_lo, numpbins, pbins, useGaussian, rtrk_los, rtrk_his);

      proj2d_hi = Project2D ("", jetRtrkHists[iPer][0][2], "x", "z", eta_lo, eta_hi, exclusive && iEta == numtrketabins);
      proj2d_hi->RebinY (rebinFactor);
      jetRtrkHist_hi = GetProfileX ("jetRtrk_Hist_hi", proj2d_hi, numpbins, pbins, useGaussian, rtrk_los, rtrk_his);
      ...
      jetRtrkHist_mc = GetProfileX ("jetRtrk_Hist_mc", proj2d_mc, numpbins, pbins, useGaussian, rtrk_los, rtrk_his);
      ...
      if (iPer != 1 && !skipSignalMC) {
        ...
        jetRtrkHist_mc_sig = GetProfileX ("jetRtrk_Hist_mc_sig", proj2d_mc_sig, numpbins, pbins, useGaussian, rtrk_los, rtrk_his);
      ...
      jetRtrkHist_rat = GetDataOverMC (Form ("jetRtrk_DataMCRatio_%s_iEta%i", per, iEta), proj2d, proj2d_mc, numpbins, pbins, useGaussian, "x", rtrk_los, rtrk_his);
      jetRtrkHist_rat_lo = GetDataOverMC (Form ("jetRtrk_DataMCRatio_lo_%s_iEta%i", per, iEta), proj2d_lo, proj2d_mc, numpbins, pbins, useGaussian, "x", rtrk_los, rtrk_his);
      jetRtrkHist_rat_hi = GetDataOverMC (Form ("jetRtrk_DataMCRatio_hi_%s_iEta%i", per, iEta), proj2d_hi, proj2d_mc, numpbins, pbins, useGaussian, "x", rtrk_los, rtrk_his);
      ...
      if (iPer != 1 && !skipSignalMC) {
        jetRtrkHist_rat_sig = GetDataOverMC (Form ("jetRtrk_DataMCRatio_Signal_%s_iEta%i", per, iEta), proj2d, proj2d_mc_sig, numpbins, pbins, useGaussian, "x", rtrk_los, rtrk_his);
        jetRtrkHist_rat_lo = GetDataOverMC (Form ("jetRtrk_DataMCRatio_Signal_lo_%s_iEta%i", per, iEta), proj2d_lo, proj2d_mc_sig, numpbins, pbins, useGaussian, "x", rtrk_los, rtrk_his);
        jetRtrkHist_rat_hi = GetDataOverMC (Form ("jetRtrk_DataMCRatio_Signal_hi_%s_iEta%i", per, iEta), proj2d_hi, proj2d_mc_sig, numpbins, pbins, useGaussian, "x", rtrk_los, rtrk_his);
    ...
    for (short iP = 0; iP <= numpbins; iP++) { // loop over bins in p
      ...
      proj2d->RebinY (rebinFactor);
      jetRtrkHist = GetProfileX ("jetRtrk_Hist", proj2d, numtrketabins, trketabins, useGaussian, rtrk_los, rtrk_his);
      ...
      proj2d_lo->RebinY (rebinFactor);
      jetRtrkHist_lo = GetProfileX ("jetRtrk_Hist_lo", proj2d_lo, numtrketabins, pbins, useGaussian, rtrk_los, rtrk_his);

      proj2d_hi = Project2D ("", jetRtrkHists[iPer][0][2], "y", "z", p_lo, p_hi);
      proj2d_hi->RebinY (rebinFactor);
      jetRtrkHist_hi = GetProfileX ("jetRtrk_Hist_hi", proj2d_hi, numtrketabins, pbins, useGaussian, rtrk_los, rtrk_his);
      ...
      proj2d_mc->RebinY (rebinFactor);
      jetRtrkHist_mc = GetProfileX ("jetRtrk_Hist_mc", proj2d_mc, numtrketabins, trketabins, useGaussian, rtrk_los, rtrk_his);
      ...
      proj2d_mc_sig->RebinY (rebinFactor);
      jetRtrkHist_mc_sig = GetProfileX ("jetRtrk_Hist_mc_sig", proj2d_mc_sig, numtrketabins, trketabins, useGaussian, rtrk_los, rtrk_his);
      ...
      jetRtrkHist_rat = GetDataOverMC (Form ("jetRtrk_DataMCRatio_%s_iP%i", per, iP), proj2d, proj2d_mc, numtrketabins, trketabins, useGaussian, "x", rtrk_los, rtrk_his);
      jetRtrkHist_rat_lo = GetDataOverMC (Form ("jetRtrk_DataMCRatio_lo_%s_iP%i", per, iP), proj2d_lo, proj2d_mc, numtrketabins, trketabins, useGaussian, "x", rtrk_los, rtrk_his);
      jetRtrkHist_rat_hi = GetDataOverMC (Form ("jetRtrk_DataMCRatio_hi_%s_iP%i", per, iP), proj2d_hi, proj2d_mc, numtrketabins, trketabins, useGaussian, "x", rtrk_los, rtrk_his);
      ...
      if (iPer != 1 && !skipSignalMC) {
        jetRtrkHist_rat_sig = GetDataOverMC (Form ("jetRtrk_DataMCRatio_Signal_%s_iP%i", per, iP), proj2d, proj2d_mc_sig, numtrketabins, trketabins, useGaussian, "x", rtrk_los, rtrk_his);
        jetRtrkHist_rat_lo = GetDataOverMC (Form ("jetRtrk_DataMCRatio_Signal_lo_%s_iP%i", per, iP), proj2d_lo, proj2d_mc_sig, numtrketabins, trketabins, useGaussian, "x", rtrk_los, rtrk_his);
        jetRtrkHist_rat_hi = GetDataOverMC (Form ("jetRtrk_DataMCRatio_Signal_hi_%s_iP%i", per, iP), proj2d_hi, proj2d_mc_sig, numtrketabins, trketabins, useGaussian, "x", rtrk_los, rtrk_his);
