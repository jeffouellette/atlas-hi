                     ...
                     const int numberEvents)
{
  ...
  //   photonSpectrum[iPCut][iWgt] = new TH2D (Form ("photonSpectrum_%s_%s_%s", data.Data (), pCut.Data (), weight.Data ()), "", numpbins, pbins, numetabins, etabins);
  //   photonSpectrum[iPCut][iWgt]->Sumw2 ();

  //   photonEtaPhi[iPCut][iWgt] = new TH2D (Form ("photonEtaPhi_%s_%s_%s", data.Data (), pCut.Data (), weight.Data ()), "", 48, -2.4, 2.4, numphibins, phibins);
