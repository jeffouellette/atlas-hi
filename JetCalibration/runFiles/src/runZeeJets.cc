...
/**
 * Runs an instance of the ZeeJets analysis routine.
...
int main (int argc, char** argv) {
  ...
  switch (argc) {
   case 3:
    ZeeJets (directory, dataSet);
    break;
   case 4:
    ZeeJets (directory, dataSet, lumi);
    break;
   case 5:
    ZeeJets (directory, dataSet, lumi, isMC);
    break;
   case 6:
    ZeeJets (directory, dataSet, lumi, isMC, isPeriodA);
    break;
   case 7:
    ZeeJets (directory, dataSet, lumi, isMC, isPeriodA, fileName);
    break;
   case 8:
    ZeeJets (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs);
    break;
   case 9:
    ZeeJets (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs, feff);
    break;
   case 10:
    ZeeJets (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs, feff, nevt);
    break;
  }
