...
/**
 * Runs an instance of the RtrkComparison analysis routine.
...
int main (int argc, char** argv) {
  ...
  switch (argc) {
   case 3:
    RtrkComparison (directory, dataSet);
    break;
   case 4:
    RtrkComparison (directory, dataSet, lumi);
    break;
   case 5:
    RtrkComparison (directory, dataSet, lumi, isMC);
    break;
   case 6:
    RtrkComparison (directory, dataSet, lumi, isMC, isPeriodA);
    break;
   case 7:
    RtrkComparison (directory, dataSet, lumi, isMC, isPeriodA, fileName);
    break;
   case 8:
    RtrkComparison (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs);
    break;
   case 9:
    RtrkComparison (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs, feff);
    break;
   case 10:
    RtrkComparison (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs, feff, nevt);
    break;
  }
