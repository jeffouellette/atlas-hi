...
/**
 * Runs an instance of the SubtractionStudy analysis routine.
...
int main (int argc, char** argv) {
  ...
  switch (argc) {
   case 3:
    SubtractionStudy (directory, dataSet);
    break;
   case 4:
    SubtractionStudy (directory, dataSet, lumi);
    break;
   case 5:
    SubtractionStudy (directory, dataSet, lumi, isMC);
    break;
   case 6:
    SubtractionStudy (directory, dataSet, lumi, isMC, isPeriodA);
    break;
   case 7:
    SubtractionStudy (directory, dataSet, lumi, isMC, isPeriodA, fileName);
    break;
   case 8:
    SubtractionStudy (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs);
    break;
   case 9:
    SubtractionStudy (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs, feff);
    break;
   case 10:
    SubtractionStudy (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs, feff, nevt);
    break;
  }
