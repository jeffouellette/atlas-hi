...
/**
 * Runs an instance of the JetAnalysis analysis routine.
...
int main (int argc, char** argv) {
  ...
  switch (argc) {
   case 3:
    JetAnalysis (directory, dataSet);
    break;
   case 4:
    JetAnalysis (directory, dataSet, lumi);
    break;
   case 5:
    JetAnalysis (directory, dataSet, lumi, isMC);
    break;
   case 6:
    JetAnalysis (directory, dataSet, lumi, isMC, isPeriodA);
    break;
   case 7:
    JetAnalysis (directory, dataSet, lumi, isMC, isPeriodA, fileName);
    break;
   case 8:
    JetAnalysis (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs);
    break;
   case 9:
    JetAnalysis (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs, feff);
    break;
   case 10:
    JetAnalysis (directory, dataSet, lumi, isMC, isPeriodA, fileName, xs, feff, nevt);
    break;
  }
