...
\begin{figure}[htbp]
	\centering
	\subfloat[]{
		\includegraphics[width=0.48\textwidth]{figures/v_jet_dataOverMC_PA_iEta_combined.pdf}
		\label{fig:v_dataOverMC_PA_pT_central}
	}
	\subfloat[]{
		\includegraphics[width=0.48\textwidth]{figures/v_jet_dataOverMC_PB_iEta_combined.pdf}
		\label{fig:v_dataOverMC_PB_pT_central}
	} \\
	\subfloat[]{
		\includegraphics[width=0.48\textwidth]{figures/v_jet_dataOverMC_PA_iEta_uncombined.pdf}
		\label{fig:v_dataOverMC_PA_pT_forward}
	}
	\subfloat[]{
		\includegraphics[width=0.48\textwidth]{figures/v_jet_dataOverMC_PB_iEta_uncombined.pdf}
		\label{fig:v_dataOverMC_PB_pT_forward}
	}
